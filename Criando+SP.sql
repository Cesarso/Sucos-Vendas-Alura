...
BEGIN
	...
	BEGIN
	   ...
	   SET @CONTADOR = @CONTADOR + 1 -- GRANTE QUE O COD DO PROD NUNCA SERA REPETIDO
	END
...
/*Com o script completo, após a solução do problema da PK,
 transforme-o numa SP chamada CriaNotaFiscal onde passamos 
 a data da nota como parâmetro. Execute 3 vezes a nova SP.*/
