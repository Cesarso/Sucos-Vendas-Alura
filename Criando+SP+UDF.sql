...
CREATE PROCEDURE BuscaPorEntidadesCompleta @ENTIDADE AS VARCHAR (20)
AS
BEGIN 
IF @ENTIDADE = 'CLIENTES'
...
ELSE IF @ENTIDADE = 'VENDEDOR'
	SELECT [MATRICULA] IDENTIFICADOR, [NOME] AS DESCRITOR, [BAIRRO] AS BAIRRO
	FROM [TABELA DE VENDEDORES]

ELSE IF @ENTIDADE = 'PRODUTOS'
	SELECT [CODIGO DO PRODUTO] AS CODIGO, [NOME DO PRODUTO] AS DESCRIÇÃO, [PREÇO DE LISTA] PREÇO
