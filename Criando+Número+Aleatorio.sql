...
-- não funciona dentro da função
CREATE FUNCTION NumeroAleatorio(@VAL_INIC INT, @VAL_FINAL INT) RETURNS INT  -- variaveis  de entrada
AS
BEGIN
...
use um loop para gravar 100 números aleatórios entre 0 e 1000 
nesta tabela. Depois,liste esta tabela em uma consulta.*/
