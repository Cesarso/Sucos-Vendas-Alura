...
/*No vídeo desta aula, 
criamos um script para obter o cliente e vendedor através da função
 de número aleatório. Neste exercício, crie o script para obter
  o produto também usando a função de número aleatório.*/
